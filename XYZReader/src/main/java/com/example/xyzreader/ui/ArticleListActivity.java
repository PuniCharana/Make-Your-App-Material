...
public class ArticleListActivity extends AppCompatActivity {
    ...
    @BindView(R2.id.swipe_refresh_layout) SwipeRefreshLayout mSwipeRefreshLayout;
    ...
    public class Adapter extends RecyclerView.Adapter<Adapter.ViewHolder> {
        ...
        public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            ...
            view.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    // Animation only supported on lolipop and above
        ...
        public class ViewHolder extends RecyclerView.ViewHolder {
            @BindView(R2.id.thumbnail) DynamicHeightNetworkImageView thumbnailView;
            @BindView(R2.id.article_title) TextView titleView;
            @BindView(R2.id.article_subtitle) TextView subtitleView;
